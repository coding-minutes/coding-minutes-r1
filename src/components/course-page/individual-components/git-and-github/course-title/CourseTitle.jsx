        ...
        <div className="course-title-inner-container">
          <div className="course-title-left">
            <div className="title">
              ...
              <h3>Git & GitHub Master Course (2022)</h3>
            </div>
            <div className="short-info">
             Git & GitHub Master Course is now on #Udemy!
            </div>
            ...
            <div className="udemy-info">
              <a href="https://www.udemy.com/course/git-github-master-course/?couponCode=JUNE420"  target="_blank">Enroll now on Udemy</a>
