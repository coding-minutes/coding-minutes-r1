        ...
        <div className="course-title-inner-container">
          <div className="course-title-left">
            ...
            <span className="first">₹ 389</span>
              ...
              <span className="last">Use Code : SANTA22</span>
            </div>
            <div className="udemy-info">
              <a href="https://www.udemy.com/course/game-theory-algorithms-in-competitive-programming-course/?couponCode=SANTA22"  target="_blank">Enroll now on Udemy</a>
